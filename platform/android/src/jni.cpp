...
jni::jobject* nativePixelForLatLng(JNIEnv *env, jni::jobject* obj, jlong nativeMapViewPtr, jdouble latitude, jdouble longitude, jni::jobject* pointF) {
...
extern "C" JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jni::RegisterNatives(env, nativeMapViewClass,
        ...
        MAKE_NATIVE_METHOD(nativePixelForLatLng, "(JDDLandroid/graphics/PointF;)Landroid/graphics/PointF;"),
